...
async fn should_find_an_existing_user() {
  ...
  let user = database::user::find_user_by_login(&db, &login).await.unwrap().unwrap();
...
async fn should_dont_panic_when_user_is_not_found() {
  ...
  let user = database::user::find_user_by_login(&db, &login).await.unwrap();
...
async fn should_find_users_organizations() {
  ...
  let organizations = database::user::find_organizations_by_user_login(&db, &login, pagination_argument)
    .await
    .unwrap();
...
async fn should_find_users_starred_repositories() {
  ...
  let repositories = database::user::find_starred_repositories_by_user_login(&db, &login, pagination_argument)
    .await
    .unwrap();
...
async fn should_find_users_followers() {
  ...
  let users = database::user::find_followers_by_login(&db, &login, pagination_argument)
    .await
    .unwrap();
...
async fn should_dont_panic_when_follower_is_not_found() {
  ...
  let repositories = database::user::find_followers_by_login(&db, &login, pagination_argument)
    .await
    .unwrap();
...
async fn should_find_followed() {
  ...
  let users = database::user::find_following_by_login(&db, &login, pagination_argument)
    .await
    .unwrap();
...
async fn should_dont_panic_when_following_is_not_found() {
  ...
  let repositories = database::user::find_following_by_login(&db, &login, pagination_argument)
    .await
    .unwrap();
...
async fn should_convert_a_follower_list_into_cursor_connection_of_users() {
  ...
  let users = database::user::find_followers_by_login(&db, &user_login, pagination_argument)
    .await
    .unwrap();

  let cursor_connection = database::user::followers_to_cursor_connection(&db, &user_login, Ok(users))
    .await
    .unwrap();
...
async fn should_convert_a_followed_list_into_cursor_connection_of_users() {
  ...
  let users = database::user::find_following_by_login(&db, &user_login, pagination_argument)
    .await
    .unwrap();

  let cursor_connection = database::user::following_to_cursor_connection(&db, &user_login, Ok(users))
    .await
    .unwrap();
...
async fn should_paginating_organizations_from_start_to_end() {
  ...
  let organizations = database::user::find_organizations_by_user_login(&db, &login, pagination_arguments)
    .await
    .unwrap();
...
async fn should_paginating_starred_repositories_from_start_to_end() {
  ...
  let repositories = database::user::find_starred_repositories_by_user_login(&db, &login, pagination_arguments)
    .await
    .unwrap();
...
async fn should_paginating_followers_from_start_to_end() {
  ...
  let users = database::user::find_followers_by_login(&db, &login, pagination_arguments)
    .await
    .unwrap();
...
async fn should_paginating_following_from_start_to_end() {
  ...
  let users = database::user::find_following_by_login(&db, &login, pagination_arguments)
    .await
    .unwrap();
